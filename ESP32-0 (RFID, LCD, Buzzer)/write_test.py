            ...
            if status == reader.OK:
                ...
                if reader.select_tag(raw_uid) == reader.OK:
                    ...
                    if reader.auth(reader.AUTH, 8, key, raw_uid) == reader.OK:
                        ...
                        # ===== CHANGED: write a string to the card =====
                        string_to_write = "Hello RFID!"  # <= your custom string
                        data_bytes = bytearray(string_to_write.ljust(16)[:16], 'utf-8')
                        status = reader.write(8, data_bytes)
                        # =================================================
